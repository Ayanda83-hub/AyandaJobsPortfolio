  ...
  return (
    <Layout title="About Ayanda">
      <section className="py-8">
        ...
        <p className="mb-6">
          I’m Ayanda Ntombela, a Business Analyst and Innovation Strategist with over a decade of experience
          leading projects in sustainability, technology, and global development.
